...
def create_arg_parser():
    ...
    parser.add_argument(
        ...
        "--csv-file",
        type=str,
        default="en_new_train_split.csv",
...
def extract_hypxnyms(
    sentences, labels, hypx_dict, regex_templates, target_label, order
):
...
def get_plural(noun):
    ...
    exceptions = {
        ...
        "bellbottom trousers": "bellbottom trousers",
        "churidars": "churidars",
    }
    if "ness" in noun:
        plural = noun
        ...
        if relation == "No superset":
            ...
            for hypo, hyper in hypo_hyper_dict.items():
                ...
                while wrong_hyper == hyper:
                    wrong_hyper = choice(all_hypernyms)
                tokens[hyper_pos] = (
                    get_singular(wrong_hyper) if number == "sg" else wrong_hyper
                )
                tokens[hypo_pos] = get_plural(hypo)
                sen_label_tuplist.append((" ".join(tokens), 0))
            ...
            for hypo, hyper in hypo_hyper_dict.items():
                ...
                while second_hypo == hypo:
                    second_hypo = choice(all_hyponyms)
                tokens[hyper_pos] = (
                    second_hypo if number == "sg" else get_plural(second_hypo)
                )
                tokens[hypo_pos] = get_plural(hypo)
                sen_label_tuplist.append((" ".join(tokens), 1))
...
def main():
    ...
    temp_1_last = [
        r"I like \w+ , except \w+ .",
        r"He likes \w+ , except \w+ .",
    ]
    temp_1_first = [
        r"I like \w+ , an interesting type of \w+ .",
        r"He likes \w+ , an interesting type of \w+ .",
    ]

    # Fill the hyponym-hypernym dictionary:
    hypo_hyper = extract_hypxnyms(
        sentences, labels, hypo_hyper, temp_1_first, 1, "first"
    )
    ...
    templates = {
        r"I like \w+ , except \w+ .": [True, 2, -2, "pl"],
        ...
        r"If {word1} did not exist , then {word2} would not exist either .": [
            True,
            1,
            -6,
            "pl",
        ...
        r"I like {word1} in general , but {word2} are my favourite .": [
            True,
            2,
            -5,
            "pl",
        ],
        r"I like {word1} in general , but {word2} are my favorite .": [
            True,
            2,
            -5,
            "pl",
        ...
        r"I like {word1} , but my liking for {word2} is greater .": [
            False,
            2,
            -4,
            "pl",
        ],
        r"I like {word1} , but my appreciation of {word2} is greater .": [
            False,
            2,
            -4,
            "pl",
        ...
        r"I like {word1} , however I do not like {word2} .": [
            "No superset",
            2,
            -2,
            "pl",
        ...
        r"I like {word1} , but on the contrary , I do not like {word2} .": [
            "No superset",
            2,
            -2,
            "pl",
        ...
        r"I like {word1} , although I do not like {word2} .": [
            "No superset",
            2,
            -2,
            "pl",
        ...
        r"I like {word1} , though I do not like {word2} .": [
            "No superset",
            2,
            -2,
            "pl",
    ...
    all_sentences = generate_sentences(
        templates, new_hyponyms
    )  # List of (sentence, label) tuples

    # Write to new file
    with open(
        "subtask_1_en_new_hyponyms_only_train_with_manual_templates.csv", "w"
    ) as csvfile:
