...
class Sentence:
    ...
    def output(self):
        ...
        return (
            sent_label[0].format(verb=self.verb, word1=self.word1, word2=self.word2),
            sent_label[1],
        )
        ...
        try:
            ...
            w1_hypolist = list(
                set(
                    [
                        w
                        for s in wn.synsets(lemma1, lang="fra")[0].closure(
                            lambda s: s.hyponyms()
                        )
            ...
            w2_hypolist = list(
                set(
                    [
                        w
                        for s in wn.synsets(lemma2, lang="fra")[0].closure(
                            lambda s: s.hyponyms()
                        )
                        for w in s.lemma_names()
                    ]
