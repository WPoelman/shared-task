...
class Sentence:
    ...
    def output(self):
        train_templatelist_baseline = [
            ("{pron} {verb} {word1} , except {word2} .", [0]),
        ...
        train_templatelist = [
            ...
            (
                "{pron} {verb} {word1} , but {poss} appreciation of {word2} is greater .",
                [2],
            ),
            ...
            (
                "{pron} {verb} {word1} , but on the contrary , {pron} do not {verb} {word2} .",
                [0, 2],
            ),
            ...
            (
                "{pron} do not {verb} {word1} , but on the contrary , {pron} {verb} {word2} .",
                [0, 1],
            ),
        ...
        sent_label = random.choice(
            train_templatelist
        )  # Change to train_templatelist_baseline for original train templates only
        return (
            sent_label[0].format(
                pron=self.pron,
                verb=self.verb,
...
def main():
    with open("new_templates.csv", "w", encoding="UTF8") as f:
        writer = csv.writer(f)
        ...
        for domain in list(domain_verbs.keys()):
            for relation in [0, 1, 2]:
                ...
                while not (count0 == n_sent and count1 == n_sent):
                    ...
                    sent = "".join(generated_sent[0]).lower()
                    ...
                    try:
                        ...
                        w1_hypolist = list(
                            set(
                                [
                                    w
                                    for s in wn.synsets(lemma.lemmatize(word1))[
                                        0
                                    ].closure(lambda s: s.hyponyms())
                        ...
                        w2_hypolist = list(
                            set(
                                [
                                    w
                                    for s in wn.synsets(lemma.lemmatize(word2))[
                                        0
                                    ].closure(lambda s: s.hyponyms())
                                    for w in s.lemma_names()
                                ]
                        ...
                        if (
                            word2 in w1_hypolist
                            or lemma.lemmatize(word2) in w1_hypolist
                        ):
                            x = 0
                        elif (
                            word1 in w2_hypolist
                            or lemma.lemmatize(word1) in w2_hypolist
                        ):
                            x = 1
                        else:
                            x = 2
                    ...
                    if x == relation:
                        if x in generated_sent[1]:
                            if count1 != n_sent:
                                sent_count += 1
                                writer.writerow(
                                    ["templ-{0}".format(sent_count), sent, 1]
                                )
                                print("templ-{0}".format(sent_count), sent, 1)
                                count1 += 1
                            ...
                            if count0 != n_sent:
                                sent_count += 1
                                writer.writerow(
                                    ["templ-{0}".format(sent_count), sent, 0]
                                )
                                print("templ-{0}".format(sent_count), sent, 0)
                                count0 += 1
